...
function adminUpdate() {
  ...
  const { AdminUpdate, host,adminAddMoney, adminDeductMoney } = context
  ...
  const handleSubmit = async (event) => {
    ...
    let res = await AdminUpdate(userInfo)
  ...
  const SaveChangeDeduct = async () => {
    ...
    let res = await adminDeductMoney({
