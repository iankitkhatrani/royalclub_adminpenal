...
function PlayerInfo({ UserId, UserName,chips, createdAt, lastLoginDate, status, uniqueId, password }) {

  const navigate = useNavigate();
  const navigateToContacts = (UserId, UserName,chips, createdAt, lastLoginDate, status, uniqueId, password) => {
    navigate('/adminedit', { state: { UserId, UserName,chips, createdAt, lastLoginDate, status, uniqueId, password } });
  }
      ...
      <td className="w-[165px] px-6 py-5 xl:px-0">
        <div className="flex justify-center">
          <button styles={{
            ...
            "cursor": "pointer",
            "border-radius": "4px"
          }} onClick={() => navigateToContacts(UserId, UserName,chips, createdAt, lastLoginDate, status, uniqueId, password)} >
