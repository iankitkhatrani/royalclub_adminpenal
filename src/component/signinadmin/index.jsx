...
function SigninAdmin() {
  ...
  const LoginDataSuperAdmin = async (data) => {
    try {
      console.log("LoginDataSuperAdmin :::::::", host)
      ...
      console.log("data api from :LoginDataSuperAdmin :::...", response)
      return response
    } catch (e) {
      console.log("e :", e)
    }
  ...
  const handleSubmit = async (e) => {
    ...
    let resData = await LoginDataSuperAdmin(formData)
    console.log(resData)
    ...
    if (resData.status) {
      ...
      cookies.set('name', resData.data.type);
      cookies.set('email', resData.data.name);
      cookies.set('logintype', "SuperAdmin");
