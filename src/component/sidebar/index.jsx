        ...
        <div className="nav-wrapper mb-[36px] pr-[50px]">
          <div className="item-wrapper mb-5">
            <ul className="mt-2.5">
              ...
              {cookies.get('name') == "Admin" ? <li
                className={`item py-[11px] text-bgray-900 dark:text-white ${location === "/admindashboard" ? "nav-active" : ""
                  } `}
              >
              ...
              {cookies.get('name') == "SuperAdmin" ? <li
                className={`item py-[11px] text-bgray-900 dark:text-white ${location === "/SuperAdminTranscation" ? "nav-active" : ""
                  } `}
              >
                <Link to="/SuperAdminTranscation">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
                      <span className="item-ico">
                        <svg
              ...
              {cookies.get('name') == "SuperAdmin" || cookies.get('name') == "Agent" ? <li
